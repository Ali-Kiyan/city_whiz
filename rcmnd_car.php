...
?>
<div class="alert alert-success">Selecet your journey...</div>
<div class="row">
    <div class="container">
...
<div class="alert alert-warning animated fadeInRight" style="width: 40%;"><?php echo $json['stations'][1]['recomendation']. " carraige is more crowded"; ?></div>
